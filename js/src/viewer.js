// 'use strict';
var BookmarkPanel = require('./viewer/BookmarkPanel');
var DEFAULT_SETTINGS = require('./DEFAULT_SETTINGS');
var MainMenu = require('./viewer/MainMenu');
var Manifest = require('./manifests/Manifest');
var ManifestsPanel = require('./viewer/ManifestsPanel');
var Utils = require('./utils/Utils');
var Workspace = require('./Workspace');
var WorkspacePanel = require('./viewer/WorkspacePanel');
...
Viewer.prototype = {
  ...
  init: function() {
    ...
    this.workspace = new Workspace({
      layoutDescription: this.layout.charAt(0) === '{' ? JSON.parse(this.layout) : Utils.layoutDescriptionFromGridString(this.layout),
      parent: this,
