// 'use strict';
var ManifestListItem = require('./ManifestListItem');
var Utils = require('../utils/Utils');

var ManifestsPanel = function(options) {
...
ManifestsPanel.prototype = {
    ...
    bindEvents: function() {
        ...
        jQuery(window).resize(Utils.throttle(function(){
